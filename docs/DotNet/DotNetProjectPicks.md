...
|  4  |[TDS]https://github.com/LdotJdot/TDS  | TDS 是一款纯 dotnet 9 开发的现代化界面高速文件搜索/启动工具，基于 Avalonia UI 技术并完美支持 aot 编译,实现并优化了如 USN 读取/近实时更新,索引磁盘缓存,索引增强搜索,多关键字匹配,多线程搜索, Avalonia UI 实现(虚拟化,全局热键,系统托盘)等功能,具有轻量高效、界面美观、交互舒适等特性。该项目以 MIT 协议开源免费,可供学习参考或自定义扩展。 | https://github.com/LdotJdot/TDS |
|  5  |  |  |  |
|  6  |  |  |  |
